document.addEventListener('DOMContentLoaded', function () {
  ...
  const customSemesterContainer = document.getElementById('customSemesterContainer');
  ...
  function loadBranchData() {
    fetch('../data/parameters.json')
      ...
      .catch(error => {
        ...
        showMessage('Failed to load branch data. Please try again later.', 'error');
      });
  }

  // Populate Branches Dropdown
  function populateBranches(branches) {
    branchSelect.innerHTML = '<option value="">Select Branch</option><option value="custom">Add Custom Branch...</option>';
  ...
  function handleBranchChange() {
    ...
    semesterSelect.innerHTML = '<option value="">Select Semester</option><option value="custom">Add Custom Semester...</option>';
    subjectSelect.innerHTML = '<option value="">Select Subject</option><option value="custom">Add Custom Subject...</option>';
  ...
  function handleSemesterChange() {
    ...
    if (branchObj && typeof branchObj === 'object') {
      const semesterObj = branchObj.semesters.find(s => s.semester === semester);
      if (semesterObj) {
  ...
  function confirmCustomSemester() {
    const customSemester = document.getElementById('customSemester').value.trim();
    if (!customSemester) {
  ...
  function handleDrop(e) {
    ...
    document.getElementById('file').files = files; // Set the files to the input element
  ...
  function handleFormSubmit(e) {
    ...
    if (!title || !file || !branch || !semester || !subject) {
  ...
  function init() {
    ...
    document.getElementById('confirmBranch').addEventListener('click', confirmCustomBranch);
    document.getElementById('confirmSemester').addEventListener('click', confirmCustomSemester);
    document.getElementById('confirmSubject').addEventListener('click', confirmCustomSubject);
