...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const setupThemeToggle = () => {
    ...
    // Function to bind theme toggle listeners
    const bindThemeToggleListeners = () => {
    ...
    // Initial bind
    bindThemeToggleListeners();
    // Re-bind after components load
    return bindThemeToggleListeners;
  };
  ...
  const loadComponents = async () => {
    try {
      ...
      const bindThemeToggle = setupThemeToggle();
      setupMobileMenu();
      // Re-bind theme toggles after components are loaded
      if (bindThemeToggle) {
        bindThemeToggle();
      }
