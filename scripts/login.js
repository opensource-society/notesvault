...
document.addEventListener("DOMContentLoaded", function () {
  ...
  // This function does not fall back to system preferences. Rather it will follow the theme from localStorage or the theme user selected in the home page.
  //   @returns {string} The stored theme ('light' or 'dark'), or 'light' as a default.

  const getStoredTheme = () => {
    return localStorage.getItem("theme") || "light";
  };

  // Applies the given theme to the document by setting the data-theme attribute on the <html> element.
  ...
  //Apply stored theme  on the page load
