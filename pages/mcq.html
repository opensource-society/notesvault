  ...
  <body>
    ...
    <main class="mcq-main">
      <div class="mcq-front">
        ...
        <div class="mcq-help">
          <a href="#" class="help-link">View help for this section</a>
        </div>
        <div class="mcq-sort">
      ...
      <div class="mcq-container" style="display:none;">
        ...
        <div id="mcqList" class="mcq-list" style="display:none;"></div>
        <button id="weeklyQuizBtn">Take Weekly Quiz</button>
